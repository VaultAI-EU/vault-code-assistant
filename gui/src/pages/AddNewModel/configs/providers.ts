...
export const providers: Partial<Record<string, ProviderInfo>> = {
  ...
  moonshot: {
    ...
    longDescription: `[Visit our documentation](https://docs.vaultai.eu/reference/Model%20Providers/moonshot) for information on obtaining an API key.`,
    icon: "moonshot.png",
    tags: [ModelProviderTags.RequiresApiKey],
    refPage: "moonshot",
  ...
  azure: {
    ...
    longDescription: `[Visit our documentation](https://docs.vaultai.eu/reference/Model%20Providers/azure) for information on obtaining an API key.
